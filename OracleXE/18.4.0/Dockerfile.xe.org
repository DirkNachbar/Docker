...
# Copy binaries
# -------------
COPY $INSTALL_FILE_1 $RUN_FILE $PWD_FILE $CHECK_DB_FILE $CUSTOM_SQL $INSTALL_DIR/
...
RUN cd $INSTALL_DIR && \
    ...
    mkdir -p $ORACLE_BASE/oradata $ORACLE_BASE/diag $ORACLE_BASE/backup $ORACLE_BASE/fast_recovery_area /home/oracle && \
    chown -R oracle:oinstall $ORACLE_BASE/oradata $ORACLE_BASE/diag /home/oracle && \
